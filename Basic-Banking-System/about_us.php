...
<body style="background-color:#212529;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px;border:50px solid rgb(173,255,47) ;background-color:black">
            <div
                style="width:80%; background-color:rgb(173,255,47); padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px gray;">
                <h1 style=" color:black;">About Us</h1>
            </div>
            <br><br>
            <img src="akash.jpeg" alt="" style="width:20%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:orange;">This website is created by</p>
            <h1 style="color:orange; text-shadow:2px 2px 2px gray;">AKASH KUMAR</h1>
            <p style="color:white;"><b>Intern at Sparks Foundation</b></p>
    </center>
