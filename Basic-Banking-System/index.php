...
<div id="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        style="font-family:candara; font-size:18px; box-shadow: 0px 0px 10px 0px black;background-color:white">
        <div class="container-fluid">
            <a href="index.php"><img src="sparks.jpg" alt=""
                    style="height: 50px; margin-left:25px; margin-top:10px;background-color:white"></a>
        ...
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:0px; text-shadow:3px 3px 3px white; text-align:center;color:RGB(173 255 47)"><b>Welcome to <br> Sparks
                        Bank!</b></p>
            </div>
            <div class="col" style="margin:4% 0% 0% 5%; text-align:center;">
                &nbsp;<img src="trans.jpg" class="zoomin" alt="" style="width:0px;margin-bottom:40px;margin-top:10px">
            </div>
        </div>
    </div>
    <img src="curve.webp" alt="" style="width:100%; position:absolute; z-index:-1">
        ...
        <div class="container"
            ...
            <div class="container" style="margin:30px 0px 20px 0px;">
                <div class="row">
                    <div class="col-lg">
                        <div
                            style="background-color:#343a40; color:RGB(173 255 47); width: 90%; border-radius:30px; box-shadow:3px 3px 8px gray; padding:20px 10px 20px 10px;">
