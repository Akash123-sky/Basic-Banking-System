...
<body style="background-color:#212529;">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        style="font-family:candara; font-size:18px; box-shadow: 0px 0px 10px 0px black; background-color: black;">
    ...
    <center>
        ...
        <div class="container" style="margin-top: 10%; padding:10px 80px 10px 80px; background-color:black">
            <div
...
echo "<tbody>";
        ...
        if(!(empty($row['sender']) && empty($row['receiver']) && empty($row['amount'])))
            ...
            <tr>
              ...
              <td>'.$row['receiver'].'</td>
              <td>'.$row['amount'].'</td>
              <td>'; ?> <?php if($row['status'] == "succeed"){echo '<b><p style="color:rgb(173,255,47);">Succeed</p></b>';}else{echo '<b><p style="color:orange;">Failed</p></b>';} ?>
              <?php echo '</td>
              </tr>';}
    }
